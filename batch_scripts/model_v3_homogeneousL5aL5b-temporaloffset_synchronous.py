...
for iter in np.arange(5,9,1):
    ...
    simulation_label = ''.join(('test_homogeneous_synchronous_L5a_L5b_temporaloffset_10ms_200mswindow_iter',str(iter)))
    if not os.path.exists("simulations/homogeneous_synchronous/"+simulation_label):
        os.mkdir("simulations/homogeneous_synchronous/"+simulation_label)
    ...
    if save_plots == True:
        fig.savefig('simulations/homogeneous_synchronous/'+simulation_label+'/stimulus.pdf')
    ...
    # if save_plots == True:
    #     fig1.savefig('simulations/homogeneous_synchronous/'+simulation_label+'/'+epochs[0]+'_firstspike.pdf')
    ...
    # if save_plots == True:
    #     fig2.savefig('simulations/homogeneous_synchronous/'+simulation_label+'/'+epochs[1]+'_firstspike.pdf')
    ...
    # if save_plots == True:
    #     fig3.savefig('simulations/homogeneous_synchronous/'+simulation_label+'/'+epochs[2]+'_firstspike.pdf')
    ...
    # if save_plots == True:
    #     fig.savefig('simulations/homogeneous_synchronous/'+simulation_label+'/raster_all_populations.pdf')
    ...
    if save_plots == True:
        fig.savefig('simulations/homogeneous_synchronous/'+simulation_label+'/FR_all_populations.pdf')
    ...
    # if save_plots == True:
    #     fig.savefig('simulations/homogeneous_synchronous/'+simulation_label+'/single_L23_Vm.pdf')
    ...
    if save_plots==True:
        res.to_csv('simulations/homogeneous_synchronous/'+simulation_label+'/population_peaks.csv')
    ...
    if save_plots == True:
        fig.savefig('simulations/homogeneous_synchronous/'+simulation_label+'/FR_peakamp_hwhm_all.pdf')
    ...
    if save_plots==True:
        fig.savefig('simulations/homogeneous_synchronous/'+simulation_label+'/L23_mean_response_curves.pdf')
