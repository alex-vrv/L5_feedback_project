...
for iter in np.arange(5,9,1):
    ...
    pairs = permutations(np.arange(-100,110,10),2)
    pairs = list(pairs)
    iterations = []
    ...
    for iteration in iterations:
        ...
        simulation_label = ''.join(('test_discrete_asynchronous_L5a',str(locked_offset),'_L5bvaried_temporaloffset_10ms_200mswindow_iter',str(iter)))
        if not os.path.exists("simulations/discrete_asynchronous/"+simulation_label):
            os.mkdir("simulations/discrete_asynchronous/"+simulation_label)
        ...
        # if save_plots == True:
        # fig.savefig('simulations/discrete_asynchronous/'+simulation_label+'/stimulus.pdf')
        ...
        # if save_plots == True:
        #     fig1.savefig('simulations/discrete_asynchronous/'+simulation_label+'/'+epochs[0]+'_firstspike.pdf')
        ...
        # if save_plots == True:
        #     fig2.savefig('simulations/discrete_asynchronous/'+simulation_label+'/'+epochs[1]+'_firstspike.pdf')
        ...
        # if save_plots == True:
        #     fig3.savefig('simulations/discrete_asynchronous/'+simulation_label+'/'+epochs[2]+'_firstspike.pdf')
        ...
        # if save_plots == True:
        #     fig.savefig('simulations/discrete_asynchronous/'+simulation_label+'/raster_all_populations.pdf')
        ...
        if save_plots == True:
            fig.savefig('simulations/discrete_asynchronous/'+simulation_label+'/FR_all_populations.pdf')
        ...
        # if save_plots == True:
        #     fig.savefig('simulations/discrete_asynchronous/'+simulation_label+'/single_L23_Vm.pdf')
        ...
        if save_plots==True:
            res.to_csv('simulations/discrete_asynchronous/'+simulation_label+'/population_peaks.csv')
        ...
        if save_plots == True:
            fig.savefig('simulations/discrete_asynchronous/'+simulation_label+'/FR_peakamp_hwhm_all.pdf')
        ...
        if save_plots==True:
            fig.savefig('simulations/discrete_asynchronous/'+simulation_label+'/L23_mean_response_curves.pdf')
